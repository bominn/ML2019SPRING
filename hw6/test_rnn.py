...
class RNN(nn.Module):
    def __init__(self, input_size, hidden_size, batch_size, num_layers=1):
        ...
        self.gru = nn.GRU(300, hidden_size,
                           ...
                           bidirectional=True, batch_first=True, dropout=0.35)
