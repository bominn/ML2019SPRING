...
def nms(boxes, scores, overlap=0.5, top_k=5):
    ...
    """
    scores = boxes[:,4].squeeze()

    boxes = boxes[:,0:4]
    #scores = boxes[:,4].squueze()
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers):
        ...
        self.focalLoss = retinanet_losses.FocalLoss()
    ...
    def forward(self, inputs):
        ...
        if self.training:
            ...
            if scores_over_thresh.sum() == 1:
                scores, num_class = classification[0, :, :].max(dim=1)
                return [scores, num_class, transformed_anchors[0,:,:]]
